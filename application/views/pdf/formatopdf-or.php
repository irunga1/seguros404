...
<body id ="pdfco" >
	<div class="container-fluid" >
		...
		<section class="max">
			...
			<div style="display:block; height: 2cm; border:1px solid gray">
				<h4 style ="border:1px solid gray">Resumen</h4>
			</div>
			...
			<section class="asinfo">
				...
				<br>
				<div><span class='lbl<?php echo $size; ?>'>Deducible Robo</span><span class="info1 num<?php echo $size ?>"><?php echo  $calculado[$i]->deducible_robo ?> </span></div>				
				<div><span class='lbl<?php echo $size; ?>'>Deducible Daños</span><span class="info1 num<?php echo $size; ?>"><?php echo  $calculado[$i]->deducible_danos ?></span></div>
			</section>
